        ...
        <section className="bg-background py-24 border-y border-border">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse bg-card rounded-sm overflow-hidden">
                <thead>
                  <tr>
                    <th className="p-4 border-b border-border font-display text-xl font-bold">Feature</th>
